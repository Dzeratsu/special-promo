<template>
  <section>
    ...
    <div class="mx-auto px-6 py-[27px] sm:my-[80px]">
      ...
      <AppButton
        link="https://www.nort-udm.ru/upload/iblock/9dc/9dc045aa52ef45933e7e5014acee286f.pdf"
        class="mt-[39px]"
      >
  ...
  data() {
    return {
      text: [
        ...
        'Невидимая огнезащита: не тонирует древесину и не изменяет цвет декоративного покрытия',
        'Не образует высолов',
      ],
    }
  },
